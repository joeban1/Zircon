...
namespace Client.Envir.Translations
{
    ...
    public class EnglishMessages : StringMessages
    {
        ...
        public override string BigMapDropsTabLabel { get; set; } = "Monster Drops";
        public override string BigMapBrowserTabLabel { get; set; } = "Item Browser";
        public override string BigMapBrowserTitle { get; set; } = "Item Browser";
        public override string BigMapBrowserButtonLabel { get; set; } = "Items";
        public override string BigMapBrowserSearchLabel { get; set; } = "Find";
        public override string BigMapBrowserAnyType { get; set; } = "Any Type";
        public override string BigMapBrowserAnyClass { get; set; } = "Any Class";
        public override string BigMapBrowserNoItems { get; set; } = "No matching items.";
        public override string BigMapBrowserNoSources { get; set; } = "No known source.";
        ...
        public override string GuidesSectionArmour { get; set; } = "Armour";
        public override string GuidesSectionAccessories { get; set; } = "Accessories";
        public override string GuidesSectionCritical { get; set; } = "Critical Gear";
        public override string GuidesNoItems { get; set; } = "No items.";
        public override string GuidesColumnItem { get; set; } = "Item";
        public override string GuidesColumnCritChance { get; set; } = "Crit %";
        public override string GuidesColumnCritDamage { get; set; } = "Crit Dmg";
